 ...
 * Author:		Les Malan
 * Date:		06/02/2022
 * File:		Malan_Assignment1.java
 * Description: This program calculates how many shares you can buy.
 */

import java.util.Scanner;

public class Malan_Assignment1 {

public static void main(String[] args) {
	// create input variable to accept data from console. Had to use second Scanner called keyboard to make the string input work. Not 100% sure why...
	...
	// calculate number of shares user can purchase based on input.
	...
	if (peRatio > 60) { // this is the warning mentioned earlier.
		System.out.println("WARNING: this company may be overvalued!");
	}
	System.out.println("# of shares able to purchase: " + (int)numberOfShares); // the (int) casts numberOfShares from double to int
